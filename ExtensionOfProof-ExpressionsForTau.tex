\sgcomment{Either we should have a proper statement for the lemma or we can just say "Below we compute the expressions for $k$ and $\tau$ for \textbf{case 1} in the proof of \textbf{\cref{LemFinMemWitnessASVNonEps} and \cref{LemFinMemWitnessASV}}", and remove the lemma and the proof environments.}
\begin{lemma}
