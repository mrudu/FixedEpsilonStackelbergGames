...
\begin{tabular}[c]{@{}c@{}}Adversarial \\ Follower\end{tabular} &
  \begin{tabular}[c]{@{}c@{}}{\color[HTML]{009901} NP-Time} \\ \\ {\color[HTML]{0000FE} \textbf{Finite Memory}} \\ {\color[HTML]{0000FE} \textbf{Strategy}} \end{tabular} &
...
\begin{tabular}[c]{@{}c@{}}Adversarial\\ Epsilon-Optimal \\ Follower\end{tabular} &
  {\color[HTML]{0000FE} \textbf{\begin{tabular}[c]{@{}c@{}}NP-Time\\ \\ Finite Memory \\ Strategy\end{tabular}}} &
  {\color[HTML]{0000FE} \textbf{\begin{tabular}[c]{@{}c@{}}Theory Of Reals/\\ \\ Solving LP \\ in EXP-Time\end{tabular}}} &
  {\color[HTML]{0000FE} \textbf{\begin{tabular}[c]{@{}c@{}}Yes\\ \\ (Requires Infinite \\ Memory)\end{tabular}}} \\ \hline
\end{tabular}
\caption{
    {\color[HTML]{0000FE} \textbf{Results obtained in our work are in blue and bold-text }} whereas {\color[HTML]{009901} results obtained in \cite{FGR20} are in green and normal-text}
}
\label{tab:results}
\end{table}

In contrast with the work in \cite{FGR20}, we assume here that the follower, Player~1, is not completely rational and always plays an epsilon-optimal best-response to the leader, Player~0's strategy.
...
We also show that Player 1 may require infinite memory to play $\epsilon$-optimal best-responses. \mbcomment{Elaborate more here}

\mbcomment{Define the Threshold Problem}
...
\mbcomment{Talk about Theory of Results}
...
\mbcomment{Move this example near the beginning of Introduction}
\begin{table}[]
    \centering
...
\mbcomment{Elaborate more on this.}
